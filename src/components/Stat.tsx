...
export function Stat({ label, value, delta, foot, className }: StatProps) {
  return (
    <div className={cn("flex flex-col gap-1.5", className)}>
      <span className="text-[.68rem] font-semibold uppercase tracking-wider text-text-3">
        {label}
      </span>
      <div className="flex items-baseline gap-2">
        ...
        {delta && (
          <span
            className={cn(
              "inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[.7rem] font-bold",
