...
// the guard (PRN-08). Every dashboard number is aggregated in SQL bounded by the
// selected range and computed here only (PRN-15). The legacy calendar-period
// readers (analyticsOverview / periodSummary) were removed in WS-9 (F-74) —
// dashboardData is the single rolling-window read side.
