...
| NF2 | Notifications v2 (new types, /notifications page, per-user + partner settings, unsubscribe) | ☐ **next up** | ✅ kickoff decisions ANSWERED 2026-08-19 (Slice 8 row): 4 new types (all per-user configurable), per-type + global unsubscribe, /notifications for BOTH roles, Q8 re-affirmed deferred (assistant untouched). Mockup-light stands. |
