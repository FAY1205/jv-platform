...
| WP-UX-4 | Map & chart honesty (legend/hatch/sentiment) | T4 | High | waived | ✅ 2026-08-16 · dark brand/warn chart-hue separation **DONE 2026-08-18 (PR #106, →`--info`)**. STILL DEFERRED: on-map choropleth labels + anchored ramp legend on Unmatched — needs state centroids |
